  ...
  public ExprNode visitFunctionCall(FunctionCall call, Void value) throws RuntimeException {
    ...
    switch(funcName) {
      ...
      case "like": {
        ...
        ExprNode arg2 = call.args.size() > 2 ? call.args.get(2).accept(this, value) : null;

        if (arg0 != null && arg0 instanceof FieldExprNode && arg1 != null && arg1 instanceof ConstantExprNode &&
            (arg2 == null || arg2 instanceof ConstantExprNode)) {
          return new FunctionExprNode(funcName,
              arg2 == null ? ImmutableList.of(arg0, arg1) : ImmutableList.of(arg0, arg1, arg2));
        }
        break;
      }
