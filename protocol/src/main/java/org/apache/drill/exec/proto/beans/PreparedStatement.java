...
public final class PreparedStatement implements Externalizable, Message<PreparedStatement>, Schema<PreparedStatement>
{
    ...
    private ByteString preparedStatementHandle;
    ...
    public PreparedStatement setPreparedStatementHandle(ByteString preparedStatementHandle)
    {
    ...
    public void mergeFrom(Input input, PreparedStatement message) throws IOException
    {
        for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
        {
            switch(number)
            {
                ...
                case 2:
                    message.preparedStatementHandle = input.readBytes();
                    break;
                default:
    ...
    public void writeTo(Output output, PreparedStatement message) throws IOException
    {
        ...
        if(message.preparedStatementHandle != null)
            output.writeBytes(2, message.preparedStatementHandle, false);
    }
    ...
    static
    {
        ...
        __fieldMap.put("preparedStatementHandle", 2);
    }
