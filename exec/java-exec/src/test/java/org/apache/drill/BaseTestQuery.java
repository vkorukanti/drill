...
public class BaseTestQuery extends ExecTest {
  ...
  public static List<QueryDataBatch>  testRunAndReturn(QueryType type, Object query) throws Exception{
    if (type == QueryType.PREPARED_STATEMENT) {
      Preconditions.checkArgument(query instanceof PreparedStatement,
          "Expected an instance of PreparedStatement as input query");
      return testPreparedStmnt((PreparedStatement)query);
    } else {
  ...
  public static List<QueryDataBatch> testPreparedStmnt(PreparedStatement preparedStatement) throws Exception {
    return client.executePreparedStatement(preparedStatement);
  }
