...
public final class SchemaUserProtos
{
    ...
    public static final class ResultColumnMetadata
    {
        ...
        public static class MessageSchema implements com.dyuproject.protostuff.Schema<org.apache.drill.exec.proto.UserProtos.ResultColumnMetadata>
        {
            public void writeTo(com.dyuproject.protostuff.Output output, org.apache.drill.exec.proto.UserProtos.ResultColumnMetadata message) throws java.io.IOException
            {
                ...
                if(message.hasDataType())
                    output.writeString(5, message.getDataType(), false);
                if(message.hasIsNullable())
                    output.writeBool(6, message.getIsNullable(), false);
                if(message.hasPrecision())
                    output.writeInt32(7, message.getPrecision(), false);
                if(message.hasScale())
                    output.writeInt32(8, message.getScale(), false);
                if(message.hasSigned())
                    output.writeBool(9, message.getSigned(), false);
                if(message.hasIsAliased())
                    output.writeBool(10, message.getIsAliased(), false);
                if(message.hasSearchability())
                    output.writeEnum(11, message.getSearchability().getNumber(), false);
                if(message.hasUpdatability())
                    output.writeEnum(12, message.getUpdatability().getNumber(), false);
                if(message.hasAutoIncrement())
                    output.writeBool(13, message.getAutoIncrement(), false);
                if(message.hasCaseSensitivity())
                    output.writeBool(14, message.getCaseSensitivity(), false);
                if(message.hasSortable())
                    output.writeBool(15, message.getSortable(), false);
                if(message.hasClassName())
                    output.writeString(16, message.getClassName(), false);
            }
        ...
        static
        {
            ...
            fieldMap.put("dataType", 5);
            fieldMap.put("isNullable", 6);
            fieldMap.put("precision", 7);
            fieldMap.put("scale", 8);
            fieldMap.put("signed", 9);
            fieldMap.put("isAliased", 10);
            fieldMap.put("searchability", 11);
            fieldMap.put("updatability", 12);
            fieldMap.put("autoIncrement", 13);
            fieldMap.put("caseSensitivity", 14);
            fieldMap.put("sortable", 15);
            fieldMap.put("className", 16);
        }
    }
    ...
    public static final class PreparedStatement
    {
        ...
        public static class MessageSchema implements com.dyuproject.protostuff.Schema<org.apache.drill.exec.proto.UserProtos.PreparedStatement>
        {
            public void writeTo(com.dyuproject.protostuff.Output output, org.apache.drill.exec.proto.UserProtos.PreparedStatement message) throws java.io.IOException
            {
                ...
                if(message.hasPreparedStatementHandle())
                    output.writeByteArray(2, message.getPreparedStatementHandle().toByteArray(), false);
                ...
                for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
                {
                    switch(number)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            builder.setPreparedStatementHandle(com.google.protobuf.ByteString.copyFrom(input.readByteArray()));
                            break;
                        default:
                            input.handleUnknownField(number, this);
                    }
        ...
        public static java.lang.String getFieldName(int number)
        {
            switch(number)
            {
                ...
                case 2: return "preparedStatementHandle";
                default: return null;
            }
        }
        public static int getFieldNumber(java.lang.String name)
        ...
        static
        {
            ...
            fieldMap.put("preparedStatementHandle", 2);
        }
    }
    ...
    public static final class RunQuery
    {
        ...
        public static class MessageSchema implements com.dyuproject.protostuff.Schema<org.apache.drill.exec.proto.UserProtos.RunQuery>
        {
            public void writeTo(com.dyuproject.protostuff.Output output, org.apache.drill.exec.proto.UserProtos.RunQuery message) throws java.io.IOException
            {
                ...
                if(message.hasPreparedStatement())
                    output.writeObject(5, message.getPreparedStatement(), org.apache.drill.exec.proto.SchemaUserProtos.PreparedStatement.WRITE, false);
        ...
        static
        {
            ...
            fieldMap.put("preparedStatement", 5);
        }
    }
